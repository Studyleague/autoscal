        ...
        <tbody>
            <tr style="vertical-align: top">
                <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                    ...
                    <div class="u-row-container" style="padding: 0px;background-color: transparent">
                        <div class="u-row"
                            style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #ff661d;">
                            <div
                                style="border-collapse: collapse;display: table;width: 100%;background-color: transparent;">
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 140%;"><strong>
                                                                    T H A N K S&nbsp; &nbsp;F O R&nbsp; &nbsp;S I G N I N G&nbsp; &nbsp;U P !</strong></p>
                                                            </div>
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 160%;"><span
                                                                        style="font-size: 22px; line-height: 35.2px;">Hi, {{$email_data['name']}}
                                                                    </span></p>
                                                                <p style="font-size: 14px; line-height: 160%;"><span
                                                                        style="font-size: 18px; line-height: 28.8px;">
                                                                        We need to verify the email address associated with your account in order to fully activate your profile.
                                                                    </span></p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;" align="left">
                                                            ...
                                                            <div align="center">
                                                                ...
                                                                <a href="https://firmingle.com/confirm-franchise-email?code={{$email_data['email_verification_link']}}" target="_blank"
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px 60px;font-family:'Cabin',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="line-height: 160%; font-size: 14px;">
                                                                    <span style="font-size: 18px; line-height: 28.8px; font-weight:700">Thank you for using Firmingle.</span>
                                                                </p>
                                                                <p style="line-height: 160%; font-size: 14px;">
                                                                    <span style="font-size: 14px; line-height: 28.8px;">
                                                                        This verification email link will expire after 24 hours of this original verification request from server.
                                                                    </span>
                                                                </p>
                                                            </div>
                                                    ...
                                                    <tr>
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:41px 55px 18px;font-family:'Cabin',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 160%;">
                                                                    <span style="font-size: 16px; line-height: 25.6px; color: #000000;">contact@firmingle.com</span>
                                                                </p>
                                                            </div>
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 180%;"><span
                                                                        ...
                                                                        &copy; Company All Rights Reserved</span></p>
                                                            </div>
