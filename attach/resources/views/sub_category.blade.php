...
<section>
    <div class="container mt-5">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="owl-carousel owl-theme" id="subcategory-carousel">
                    @foreach ($sub_category as $sub_cat)

                        <div class="item row">
                            <div class="col-12">
                                <a href="{{ route('child_cat_by_id', Crypt::encrypt($sub_cat->id)) }}">
                                    <div class="subcategory-services text-center mx-2">
            ...
            <div class="col-lg-12">
                <p class="text-right">
                    <a href="{{ route('cat_by_id',Crypt::encrypt($service_id)) }}" class="btn btn-custom">View All</a>
                </p>
            </div>
        </div>
    </div>
