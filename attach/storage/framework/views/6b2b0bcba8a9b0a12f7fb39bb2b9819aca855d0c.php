<?php $__env->startSection('title','Car Insuarance'); ?>
                ...
                <header class="page-header">
                    ...
                    <div class="right-wrapper text-right">
                        <ol class="breadcrumbs">
                            ...
                            <li><span>Car Insuarance</span></li>
                        </ol>
                    ...
                    <div class="col">
                        <section class="card">
                            <header class="card-header mt-3">
                                <h2 class="card-title">Car Insuarance</h2>
                            </header>
                            <div class="card-body">
                                ...
                                <table class="table table-bordered table-striped mb-0" id="datatable-tabletools">
                                    ...
                                    <tbody id="tableContainer">
                                        <?php $__empty_1 = true; $__currentLoopData = $insuarance; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
...
<?php /**PATH /var/www/leadstoclient.tech/html/TCD/attach/resources/views/admin/car_insuarance.blade.php ENDPATH**/ ?>