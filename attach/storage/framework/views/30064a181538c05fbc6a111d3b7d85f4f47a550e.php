                                    ...
                                    <tbody id="tableContainer">
                                        <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="user_pets/<?php echo e(base64_encode($user->id)); ?>" target="_blank"><button type="button" class="btn btn-success btn-lg" >Pets</button></a>
                                                </td>
                                                <?php if($user->status): ?>
...
<?php /**PATH E:\AQIB\c2c\pet\attach\resources\views/admin/users.blade.php ENDPATH**/ ?>