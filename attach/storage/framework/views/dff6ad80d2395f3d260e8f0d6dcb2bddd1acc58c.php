                                    ...
                                    <tbody id="tableContainer">
                                        <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="user_orders/<?=base64_encode($user->id)?>" target="_blank"><button type="button" class="btn btn-success btn-lg" >Orders</button></a>
                                                </td>
...
<?php /**PATH /var/www/leadstoclient.tech/html/TCD/attach/resources/views/admin/users.blade.php ENDPATH**/ ?>