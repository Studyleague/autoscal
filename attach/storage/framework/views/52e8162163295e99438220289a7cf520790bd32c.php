...
<div class="table-section bill-tbl w-100 mt-10">
    ...
    <table class="table w-100 mt-10">
        <tr>
            <th style="font-size:20px">Purchase Customer Details</th>
        </tr>
        <tr>
            <td>
                <div class="box-text">
                    <p style="font-size:20px">Purchase Customer Name : <?php echo e($customer_details['purchase_cust_name']); ?></p>
                    <p style="font-size:20px">Purchase Customer Number: <?php echo e($customer_details['purchase_cust_no']); ?></p>
    ...
    <table class="table w-100 mt-10">
        <tr>
            <th style="font-size:20px">Sell Customer Details</th>
        </tr>
        <tr>
            <td>
                <div class="box-text">
                    <p style="font-size:20px">Sell Customer Name : <?php echo e($customer_details['sell_cust_name']); ?></p>
                    <p style="font-size:20px">Sell Customer Number: <?php echo e($customer_details['sell_cust_no']); ?></p>
...
<div class="table-section bill-tbl w-100 mt-10">
    ...
    <div>
        <p>
            ...
            3) This inspection report was generated by TCD based on the request raised by the party, whom the report is addressed to, for the stated purpose only. TCD will not be responsible for any loss incurred by the party relying on the inspection report. <br>
        </p>
    </div>
</div>
</html>
<?php /**PATH /var/www/leadstoclient.tech/html/TCD/attach/resources/views/admin/sample_pdf.blade.php ENDPATH**/ ?>