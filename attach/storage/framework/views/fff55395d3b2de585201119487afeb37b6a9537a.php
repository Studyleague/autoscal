											...
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														...
														<div class="info">
															<strong class="amount"><?php echo e($user_count); ?></strong>
														</div>
													</div>
											...
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														...
														<div class="info">
															<strong class="amount"><?php echo e($total_inspection_count); ?></strong>
														</div>
													</div>
													<div class="summary-footer">
											...
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														...
														<div class="info">
															<strong class="amount"><?php echo e($pending_inspection_count); ?></strong>
														</div>
													</div>
													<div class="summary-footer">
														<a class="text-muted text-uppercase" href="#">(view Detail)</a>
											...
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														...
														<div class="info">
															<strong class="amount"><?php echo e($completed_inspection_count); ?></strong>
														</div>
													</div>
													<div class="summary-footer">
														<a class="text-muted text-uppercase" href="#">(view Detail)</a>
											...
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														...
														<div class="info">
															<strong class="amount"><?php echo e($ongoing_inspection_count); ?></strong>
														</div>
													</div>
													<div class="summary-footer">
														<a class="text-muted text-uppercase" href="#">(view Detail)</a>
...
<?php /**PATH /var/www/leadstoclient.tech/html/TCD/attach/resources/views/admin/home.blade.php ENDPATH**/ ?>