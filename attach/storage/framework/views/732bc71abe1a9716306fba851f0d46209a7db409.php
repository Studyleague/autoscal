<?php $__env->startSection('title','Cancelled Leads'); ?>
                ...
                <header class="page-header">
                    ...
                    <div class="right-wrapper text-right">
                        <ol class="breadcrumbs">
                            ...
                            <li><span>Cancelled Leads</span></li>
                        </ol>
                    ...
                    <div class="col">
                        <section class="card">
                            <header class="card-header mt-3">
                                <h2 class="card-title">Cancelled Leads</h2>
                            </header>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                    ...
                                    <tbody id="tableContainer">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?=$val->total?></td>
                                                <td>
                                                    <?php $partner = optional($val->partner); ?>
                                                    <?php echo e($partner->name); ?>

                                                </td>
                                                <td><?php echo e(($val->reason) ? $val->reason : "--"); ?></td>
                                                <td>
...
<?php /**PATH /var/www/leadstoclient.tech/html/TCD/attach/resources/views/admin/cancel_orders.blade.php ENDPATH**/ ?>